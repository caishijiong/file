...
在这个语句中，我们明确了插入的顺序，第一个字段对应create_time，第二个字段对应name，第三个hobby，第四个age，values里面的值是与之对应的

```sql
INSERT INTO user(`create_time`,`name`,`hobby`,`age`) VALUES('2025-10-17 09:19:00','代号玖','磨刀',20)
```
...
```sql
UPDATE `user` SET name='元大鹰', age=30, hobby='篮球' WHERE id = 17;
```
